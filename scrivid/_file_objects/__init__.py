...
from .adjustments import (
    HideAdjustment, MoveAdjustment, RootAdjustment, ShowAdjustment
)
...
__all__ = [
    "create_image_reference", "define_properties", "FileReference", 
    "HideAdjustment", "ImageFileReference", "ImageReference", "MoveAdjustment",
