...
from .adjustments import HideAdjustment, MoveAdjustment, ShowAdjustment
...
__all__ = [
    ...
    "ImageReference", "MoveAdjustment", "properties", "Properties", "ShowAdjustment", "VisibilityStatus"
]
